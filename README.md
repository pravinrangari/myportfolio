# Project Overview
A Dynamic Portfolio project built using Spring Boot, JSP, and MySQL, enabling users to display and manage professional details securely.
...
- Profile Management – Upload and update personal data & profile images.
